...
export const signUpUser = async (userInfo) => {
    const res = await axios.post('http://ec2-3-35-22-107.ap-northeast-2.compute.amazonaws.com:8080/user', userInfo);
    return res.data;
};

export const loginUser = async (userInfo) => {
    const res = await axios.post('http://ec2-3-35-22-107.ap-northeast-2.compute.amazonaws.com:8080/login', userInfo);
